...
col1, col2, col3 = st.columns([1, 3, 1])  # the 1, 3, 1 define the width of the columns
...
with col2:
    ...
    st.image("../imgs/KeychronK3-modified.png")

    # create another columns inside the other columns to center the link/text
    col4, col5, col6, col7, col8 = st.columns([1, 1, 3, 1, 1])
    with col4:
        pass
    with col5:
        pass
