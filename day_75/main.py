...
# filter only for data until 2019
df_unemployment = df_unemployment[df_unemployment["MONTH"] < "2019-12-31"]
# Calculate the rolling average over a 6 month window
roll_df = df_unemployment[["UE_BENEFITS_WEB_SEARCH", "UNRATE"]].rolling(window=6).mean()
# Displays chart explicitly
ax1.plot(df_unemployment.MONTH, roll_df.UNRATE, color="#FD9A9F")
ax2.plot(df_unemployment.MONTH, roll_df.UE_BENEFITS_WEB_SEARCH, color="skyblue")
plt.show()

# print((df_unemployment[df_unemployment["MONTH"] < "2019-07-01"]))
